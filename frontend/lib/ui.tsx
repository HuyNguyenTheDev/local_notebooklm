...
const translations: Record<Language, Dict> = {
  en: {
    ...
    newChat: "New chat",
    loadingChatSessions: "Loading sessions...",
    noChatSessions: "No chats yet",
    renameChat: "Rename chat",
    deleteChat: "Delete chat",
    saveChatName: "Save chat name",
    // Workspace page
    sources: "Sources",
    chat: "Chat",
  ...
  vi: {
    ...
    chatSessionsTitle: "Phiên chat",
    newChat: "Chat mới",
    loadingChatSessions: "Đang tải phiên chat...",
    noChatSessions: "Chưa có phiên chat",
    renameChat: "Đổi tên phiên chat",
    deleteChat: "Xóa phiên chat",
    saveChatName: "Lưu tên phiên chat",
    // Workspace page
